		...
		const checkMobile = () => {
			...
			if (!isMobile) {
				toast({
					...
					description:
						"This page is designed for mobile phones. Please scan the QR code with your phone instead.",
					variant: "destructive",
				});
			}
		};
	...
	useEffect(() => {
		...
		if (session) {
			...
			toast({
				...
				description:
					"No session ID found in URL. Please scan the QR code from the desktop application.",
				variant: "destructive",
			});
		}
	}, [toast]);
							...
							>
								...
								{!isMobileDevice && (
									<div className="mb-6 p-3 bg-amber-800/30 rounded-lg text-amber-200 text-sm">
										...
										<p className="mt-1">
											Please scan the QR code with your phone instead.
										</p>
									</div>
								)}

								<p className="text-gray-300 mb-6">
									BiometricSync needs access to your camera to analyze facial
									features and biometric data.
								</p>
						...
						<div className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-black/80 to-transparent p-6">
							<div className="space-y-3">
								...
								<div className="flex items-center justify-between">
									...
									<div className="text-sm metrics-pulse text-green-400">
										Active
									</div>
								</div>
							</div>
